...
![image.png](https://file.stevepaul101.net/20251202165826141.png)
...
![image.png](https://file.stevepaul101.net/20251202172411078.png)
...
server {  
       listen 443 ssl;  
       ssl_certificate /etc/letsencrypt/live/file.stevepaul101.net/cert.pem;  
       ssl_certificate_key /etc/letsencrypt/live/file.stevepaul101.net/privkey.pem;  
       server_name file.stevepaul101.net;  
       location / {  
...
       listen 80;  
       server_name file.stevepaul101.net;  
       return 301 https://file.stevepaul101.net$request_uri;  
}
```

这样，我们访问 https://file.stevepaul101.net/xxx 就可以访问到图床（存储桶）的 xxx 文件了。
...
上传附件后 PicGo 会给你附件的外链，你会发现这个外链可能还是 OSS 的域名，而你当然希望返回的是关联到 ECS 的域名。这可以通过在 PicGo 中设定自定义域名进行修改——比如我就会设定为 https://file.stevepaul101.net 。
...
![image.png](https://file.stevepaul101.net/20251202175559310.png)
